...
namespace THPTUDWeb.Areas.Admin.Controllers
{
    public class SliderController : Controller
    {
        ...
        {
            return View(slidersDAO.getList("Index"));//Hiển thị toàn bộ danh sách Slider
        }
        /////////////////////////////////////////////////////////////////////////////////////
        ...
        public ActionResult Status(int? id)
        {
            ...
            //Khi nhấn nút thay đổi Status cho một mẩu tin
            Sliders sliders = slidersDAO.getRow(id);
            //Check ID của slider có tồn tại không?
            if (sliders == null)
            {
                //Thông báo thất bại
                TempData["message"] = new XMessage("danger", "Cập nhật trạng thái thất bại");
            ...
            //Thay đổi trạng thái của Slider từ 1 sang 2 và ngược lại
            ...
            //Gọi hàm Update trong SliderDAO
        ...
        public ActionResult Edit(Sliders sliders)
        {
            if (ModelState.IsValid)
            {
                ...
                slidersDAO.Update(sliders);
                //Thong bao thanh cong
                TempData["message"] = new XMessage("success", "Chỉnh sửa thông tin Slider thành công");
                return RedirectToAction("Index");
            }
            return View(sliders);
        }
        ...
        public ActionResult DelTrash(int? id)
        {
            ...
            //Goi ham Update trong sliders DAO
            slidersDAO.Update(sliders);
